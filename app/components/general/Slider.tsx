        ...
        <div style={sliderStyle} >
            ...
            <div className='  w-1/2 h-[550px] flex items-center '>
                ...
                <div className='!flex items-center   '>
                    ...
                    <div className='  w-1/2 h-[550px] flex items-center '>
                      <img  src="./images/Ekran görüntüsü 2023-12-13 211358.png" className='object-cover' alt="" />
                ...
                <div className='!flex items-center   '>
                    ...
                    <div className='  w-1/2 h-[550px] flex items-center '>
                      <img  src="./images/superfly-9-academy-mercurial-dream-speed-mg-yüksek-bilekli-krampon-39fWKG.png" className='object-cover' alt="" />
