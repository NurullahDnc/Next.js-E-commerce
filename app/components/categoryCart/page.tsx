...
const CategoryPage = ({product} : {product:any}) => {
  ...
  return (
    ...
    className="md:min-w-[270px] md:max-w-[280px] min-w-[170px] max-w-[170px]  min-h-[240px] max-h-[250px] md:min-h-[380px] md:max-h-[390px] overflow-hidden border rounded-md cursor-pointer shadow-md flex flex-1 flex-col  ">
